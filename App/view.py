...
def printMenu():
    ...
    print("2- Cargar Tags")
    print("3- Cargar identificador de libro")
    print("0- Salir")
...
while True:
    ...
    if int(inputs[0]) == 1:
        ...
        print("Cargando información de identificador de libros")
        identificador =loadbook_tags()
        print('Total de identificadores de libros cargados:' + str(lt.size(book_tags)))
